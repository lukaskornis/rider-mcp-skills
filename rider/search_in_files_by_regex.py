...
def main():
    require(2, "python search_in_files_by_regex.py <pattern> [file_mask] [dir] [limit] [project_path]")
    params = {"regexPattern": sys.argv[1]}
    ...
    print(json.dumps(command("search_in_files_by_regex", params), indent=2))
